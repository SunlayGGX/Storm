...
- **dimension (vector3, mandatory)**: This defines the dimension of the blower (interpreted differently depending on the blower type. This setting is mandatory and no coordinate can be 0. For a Sphere, the x value will be taken as a radius, for a cube, this is the dimension of a cube 1x1x1...
- **position (vector3, facultative)**: This defines the position of the origin center of the blower. Default is { x=0.0, y=0.0, z=0.0 }...
