...
- **layerCount (positive integer, facultative)**: The boundary particles layer to generate along the rigid body surface. Should be a non zero positive integer between 1 and 5. Default is 1.
