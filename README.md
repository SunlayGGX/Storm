...
- **layeringGeneration (string, facultative)**: The technique used to generate boundary particles layer on the rigid body surface. It isn't case sensitive and the accepted values are "Scaling" (default).
