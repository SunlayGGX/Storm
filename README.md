...
- **makeRigidbody (boolean, facultative)**: Specify if we should generate a rigid body around the blower. Default is false... Note that it is forbidden for sphere blowers.
