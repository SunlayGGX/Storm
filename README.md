...
- **geometry (string, facultative)**: Geometry type of the rigidbody. It isn’t case sensitive and the accepted values are “Sphere” and “Cube”. Only available if we chose Uniform as layering generation technique.
