...
namespace Storm
{
	...
	public:
		...
		virtual const Storm::GeneralSafetyConfig& getGeneralSafetyConfig() const = 0;
		virtual const Storm::GeneralArchiveConfig& getGeneralArchiveConfig() const = 0;
