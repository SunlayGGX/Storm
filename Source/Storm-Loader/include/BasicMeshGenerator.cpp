...
void Storm::BasicMeshGenerator::generateCube(const Storm::Vector3 &position, const Storm::Vector3 &dimension, std::vector<Storm::Vector3> &inOutVertexes, std::vector<uint32_t> &inOutIndexes)
{
	...
	// indexes
	STORM_REGISTER_TRIANGLE_INDEX(0, 1, 2);
	STORM_REGISTER_TRIANGLE_INDEX(1, 3, 2);
	STORM_REGISTER_TRIANGLE_INDEX(0, 4, 1);
	STORM_REGISTER_TRIANGLE_INDEX(1, 4, 5);
	STORM_REGISTER_TRIANGLE_INDEX(0, 2, 4);
	STORM_REGISTER_TRIANGLE_INDEX(2, 6, 4);
	STORM_REGISTER_TRIANGLE_INDEX(1, 5, 3);
	STORM_REGISTER_TRIANGLE_INDEX(3, 5, 7);
	STORM_REGISTER_TRIANGLE_INDEX(2, 7, 6);
	STORM_REGISTER_TRIANGLE_INDEX(4, 6, 7);
	STORM_REGISTER_TRIANGLE_INDEX(4, 7, 5);
}
