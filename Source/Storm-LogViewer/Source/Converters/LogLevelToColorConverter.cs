...
namespace Storm_LogViewer.Source.Converters
{
    class LogLevelToColorConverter : IValueConverter
    {
        public object Convert(object value, Type targetType, object parameter, CultureInfo culture)
        {
            ...
            case Log.LogLevelEnum.Warning: return new SolidColorBrush(Color.FromRgb(200, 130, 25));
            case Log.LogLevelEnum.Error: return new SolidColorBrush(Color.FromRgb(250, 70, 40));
            case Log.LogLevelEnum.Fatal: return new SolidColorBrush(Color.FromRgb(255, 10, 10));
