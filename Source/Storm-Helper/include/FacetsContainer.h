	...
	private:
		...
		public:
			...
			void registerFacet(ItemType &&item)
			{
				...
				{
					Storm::throwException<Storm::Exception>("A facet was already found in the facet map position (" + toStdString(Facet::ID) + ")!");
				}
			}
		...
		public:
			...
			void registerFacet(ItemType &&item)
			{
				...
				{
					Storm::throwException<Storm::Exception>("A facet was already found in the facet contiguous container position (" + toStdString(index) + ")!");
				}
			}
