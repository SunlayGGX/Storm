...
void Storm::RecordWriter::endWrite(float realEndPhysicsTime)
{
	Storm::RecordHandlerBase::endWriteHeader(_headerPosition, _frameNumber, realEndPhysicsTime);
